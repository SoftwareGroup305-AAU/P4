...
public partial class CBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="CParser.vcSpecificModifer"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitVcSpecificModifer([NotNull] CParser.VcSpecificModiferContext context) { return VisitChildren(context); }
	/// <summary>
