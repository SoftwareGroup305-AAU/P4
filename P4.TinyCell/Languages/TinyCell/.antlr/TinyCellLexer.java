...
public class TinyCellLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"MODASSIGN", "MINUSASSIGN", "QUOTE", "MULT", "DIV", "PLUS", "MINUS", 
			"MOD", "AND", "OR", "EQ", "NEQ", "GT", "LT", "GTE", "LTE", "NOT", "BITSHIFTL", 
	...
	public TinyCellLexer(CharStream input) {
		super(input);
